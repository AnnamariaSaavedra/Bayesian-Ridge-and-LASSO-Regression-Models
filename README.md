...
-  *Simulation framework results* folder contains the sensitivity analyses on hyperparameter elicitation results for sigma2, lambda, and alpha and the proposed models results for the simulated datasets.
